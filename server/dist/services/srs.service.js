...
class SRSService {
     ...
     */
    static calculateNextReview(currentLevel, isCorrect) {
        ...
        if (isCorrect) {
            ...
            switch (nextLevel) {
                case 1:
                    nextReviewDate = (0, date_fns_1.addDays)(new Date(), 1); // 1 day
                    break;
                case 2:
                    nextReviewDate = (0, date_fns_1.addDays)(new Date(), 3); // 3 days
                    break;
                case 3:
                    nextReviewDate = (0, date_fns_1.addDays)(new Date(), 7); // 7 days
                    break;
                case 4:
                    nextReviewDate = (0, date_fns_1.addDays)(new Date(), 14); // 14 days
                    break;
                case 5:
                    nextReviewDate = (0, date_fns_1.addDays)(new Date(), 30); // 30 days
                    break;
                default:
                    nextReviewDate = (0, date_fns_1.addHours)(new Date(), 4); // Backup
            }
        }
        else {
            ...
            nextReviewDate = (0, date_fns_1.addHours)(new Date(), 1); // Review in 1 hour
        }
     ...
     */
    static getDueIntervalQuery(userId) {
        return {
            where: {
                userId,
                nextReviewAt: {
