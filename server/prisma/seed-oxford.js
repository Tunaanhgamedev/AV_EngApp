...
const OXFORD_WORDS = [
  ...
  'anybody','anymore','anyone','anything','anyway','anywhere','apart','apartment','apologize','apparently',
  ...
  'discussion','discussion','disease','dishonest','dislike','dismiss','distribute','distribution','divide',
...
async function main() {
  ...
  console.log('Seeding Oxford words via Prisma (JS)...');
  ...
  for (const word of OXFORD_WORDS) {
    ...
    try {
      ...
      added++;
      if (added % 100 === 0) console.log(`Progress: ${added} words...`);
    } catch (e) {
      // Ignore
    }
  }

  console.log(`✅ Seeded ${added} words successfully.`);
