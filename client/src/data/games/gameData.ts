export const STATIC_WORD_PAIRS = [
...
export const STATIC_SCRAMBLE_SENTENCES = [
...
export const STATIC_SCRAMBLE_IDIOMS = [
...
export const IMAGE_GUESS_POOL = [
  ...
  },
  {
    word: 'AIRPLANE',
    vi: 'Máy bay',
    hint: 'Phương tiện giao thông trên không khổng lồ có cánh.',
...
export const GAME_CATALOG_DATA = [
  ...
  { id: 'wordHunter', title: "Word Hunter", description: "Đoán chữ cái ẩn (Hangman). Nhập các chữ cái để tìm ra từ vựng bí mật trước khi hết lượt chơi!", color: "bg-rose-600", shadow: "shadow-rose-600/20", xp: "+80 XP", players: "1.3k đang chơi" },
  { id: 'imageGuess', title: "Image Guessing", description: "Đoán từ qua hình ảnh. Nhìn hình ảnh thực tế và ghép các chữ cái thành từ tiếng Anh chuẩn xác!", color: "bg-amber-500", shadow: "shadow-amber-500/20", xp: "+100 XP", players: "1.5k đang chơi" },
  { id: 'sentence', title: "Sentence Builder", description: "Nối từ thành câu. Lắp ghép các từ vựng lộn xộn thành câu nói chuẩn ngữ pháp!", color: "bg-emerald-500", shadow: "shadow-emerald-500/20", xp: "+75 XP", players: "1.1k đang chơi" },
  { id: 'idiom', title: "Idiom Connector", description: "Nối từ thành thành ngữ. Khám phá kho tàng thành ngữ tiếng Anh qua trò chơi ghép chữ lý thú!", color: "bg-violet-500", shadow: "shadow-violet-500/20", xp: "+120 XP", players: "640 đang chơi" }
];
