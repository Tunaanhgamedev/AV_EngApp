    ...
    <section className="premium-card p-8 bg-gradient-to-r from-red-50 to-rose-50 border-red-100">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center md:text-left">
          <h3 className="text-2xl font-black text-slate-800">Sẵn sàng thử sức với bài thi IELTS Full Test?</h3>
          <p className="text-sm text-slate-500 font-medium">Trải nghiệm thi thử 4 kĩ năng trong môi trường mô phỏng thi thật 100%.</p>
        </div>
        <button
