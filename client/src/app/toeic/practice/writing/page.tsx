    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center space-y-6">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-black text-slate-800 dark:text-slate-100 animate-pulse">Đang tải đề thi viết...</h2>
          <p className="text-sm text-slate-400 dark:text-slate-500 font-bold">AI đang lựa chọn bức ảnh công sở ngẫu nhiên</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        <button 
          ...
          className="flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 font-bold text-sm transition-colors cursor-pointer"
        >
          <ArrowLeft className="w-4 h-4" />
          Quay lại TOEIC Center
        </button>
        <span className="px-3 py-1 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-900/50 text-emerald-700 dark:text-emerald-400 rounded-full text-xs font-bold flex items-center gap-1.5">
      ...
      <div className="text-center md:text-left space-y-2">
        <h1 className="text-3xl font-black text-slate-800 dark:text-slate-100">✍️ Luyện Viết Mô Tả Tranh</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="premium-card p-2 border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden rounded-3xl bg-white dark:bg-slate-900">
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 rounded-2xl space-y-2">
            <div className="flex items-center gap-1.5 text-slate-700 dark:text-slate-300 font-black text-xs uppercase tracking-wider">
        ...
        <div className="space-y-6">
          <div className="premium-card p-6 border-slate-100 dark:border-slate-800 shadow-xl space-y-6 bg-white dark:bg-slate-900">
            
            {/* Keywords section */}
            <div className="space-y-3">
              <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Từ khóa bắt buộc sử dụng</h3>
              <div className="flex flex-wrap gap-2.5">
                {challenge.keywords.map((kw, idx) => {
                  ...
                  return (
                    ...
                    >
                      {matched ? <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" /> : <span className="w-1.5 h-1.5 rounded-full bg-slate-400 dark:bg-slate-500" />}
                      {kw}
                    </span>
                  );
                })}
            ...
            <div className="space-y-3 border-t border-slate-50 dark:border-slate-800/50 pt-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Giới hạn độ dài</h3>
                <span className={cn(
                  "text-xs font-bold px-2 py-0.5 rounded-lg",
                  isLengthValid ? "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400" : "bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400"
                )}>
            ...
            <div className="space-y-2 border-t border-slate-50 dark:border-slate-800/50 pt-4">
              <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Bài viết của bạn</h3>
              <textarea
                value={userText}
      ...
      {result && (
        <div className="premium-card p-8 border-emerald-100 dark:border-emerald-900/50 bg-gradient-to-br from-white dark:from-slate-900 to-emerald-50/10 dark:to-emerald-900/10 shadow-2xl rounded-3xl space-y-8 animate-in fade-in slide-in-from-top-6 duration-500">
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-6 gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-slate-800 dark:text-slate-100">Kết Quả Đánh Giá Từ Giám Khảo AI</h2>
                <p className="text-xs text-slate-400 dark:text-slate-500 font-bold flex items-center gap-1.5 mt-0.5">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mt-1">Overall Band Score</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Criteria 1 */}
            <div className="p-4 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm space-y-2">
              <div className="flex justify-between items-center text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <span>Đúng (Grammar)</span>
                <span className="text-slate-800 dark:text-slate-100 font-extrabold">{result.grammarScore} / 10</span>
              </div>
            ...
            <div className="p-4 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm space-y-2">
              <div className="flex justify-between items-center text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                ...
                <span className="text-slate-800 dark:text-slate-100 font-extrabold">{result.lengthScore} / 10</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-700 h-2 rounded-full overflow-hidden">
                <div 
            ...
            <div className="p-4 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm space-y-2">
              <div className="flex justify-between items-center text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                ...
                <span className="text-slate-800 dark:text-slate-100 font-extrabold">{result.relevanceScore} / 10</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-700 h-2 rounded-full overflow-hidden">
                <div 
            ...
            <div className="p-4 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm space-y-2">
              <div className="flex justify-between items-center text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                ...
                <span className="text-slate-800 dark:text-slate-100 font-extrabold">{result.styleScore} / 10</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-700 h-2 rounded-full overflow-hidden">
                <div 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Corrected Text card */}
              <div className="p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm space-y-3 relative">
                <div className="flex justify-between items-center">
                  <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Bản sửa lỗi tối ưu từ AI</h3>
                  <button 
                    onClick={handleCopy}
                    className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-xl transition-colors cursor-pointer text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
                  >
              ...
              <div className="p-6 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl shadow-sm space-y-3">
                <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Nhận xét chi tiết</h3>
                <div className="text-slate-600 dark:text-slate-300 text-xs font-semibold leading-relaxed space-y-2 whitespace-pre-line">
                  {result.feedback}
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="p-5 bg-slate-900 text-white rounded-2xl shadow-sm space-y-4">
                <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Đối chiếu cấu trúc</h3>
                
                <div className="space-y-2">
                  <span className="text-[10px] font-black uppercase text-rose-400">Câu của bạn:</span>
                  <p className="text-xs font-bold text-slate-300 dark:text-slate-400 leading-relaxed italic">"{userText}"</p>
                </div>

                <div className="border-t border-slate-800 pt-3 space-y-2">
                  <span className="text-[10px] font-black uppercase text-emerald-400">Đề xuất nâng cấp:</span>
                  <p className="text-xs font-bold text-slate-200 dark:text-slate-300 leading-relaxed italic">"{result.correctedText}"</p>
                </div>
              </div>
            </div>
