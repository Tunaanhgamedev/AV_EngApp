            ...
            <div className="flex flex-row md:flex-col overflow-x-auto md:overflow-visible gap-2 pb-2 md:pb-0 no-scrollbar">
              {TOPIC_LESSONS.map(t => (
                ...
                >
                  ...
                  <h4 className={cn("text-xs md:text-sm font-bold text-slate-800 transition-colors pl-1 whitespace-nowrap md:whitespace-normal", selectedTopicId === t.id && "text-violet-750 font-black")}>{t.title}</h4>
