...
export const VOCABULARY_TOPICS: VocabTopic[] = [
  ...
  },
  {
    ...
    beginner: [
      ...
      { word: 'chicken', phonetic: '/ˈtʃɪk.ɪn/', wordType: 'noun', meaningEn: 'a common farm bird kept for its eggs and meat', meaningVi: 'con gà', example: 'The chicken laid an egg.', exampleVi: 'Con gà đã đẻ một quả trứng.' },
      { word: 'cow', phonetic: '/kaʊ/', wordType: 'noun', meaningEn: 'a large female farm animal kept for its milk or meat', meaningVi: 'con bò', example: 'Cows eat fresh grass.', exampleVi: 'Bò ăn cỏ tươi.' },
      { word: 'frog', phonetic: '/frɒɡ/', wordType: 'noun', meaningEn: 'a small green animal with long back legs for jumping, living in water or on land', meaningVi: 'con ếch', example: 'The frog jumped into the water.', exampleVi: 'Con ếch nhảy xuống nước.' },
      { word: 'snake', phonetic: '/sneɪk/', wordType: 'noun', meaningEn: 'a long reptile with no legs that slides along the ground', meaningVi: 'con rắn', example: 'A snake can shed its skin.', exampleVi: 'Một con rắn có thể lột da.' },
      { word: 'turtle', phonetic: '/ˈtɜː.təl/', wordType: 'noun', meaningEn: 'a slow reptile with a hard round shell protecting its body', meaningVi: 'con rùa', example: 'The sea turtle swimming slowly.', exampleVi: 'Chú rùa biển bơi lội chậm rãi.' }
    ],
    advanced: [
      ...
      { word: 'amphibian', phonetic: '/æmˈfɪb.i.ən/', wordType: 'noun', meaningEn: 'an animal that can live both on land and in water', meaningVi: 'lớp lưỡng cư', example: 'Frogs are the most common amphibians.', exampleVi: 'Ếch là loài động vật lưỡng cư phổ biến nhất.' },
      { word: 'vertebrate', phonetic: '/ˈvɜː.tɪ.brət/', wordType: 'noun', meaningEn: 'an animal that has a backbone or spinal column', meaningVi: 'động vật có xương sống', example: 'Humans and birds are vertebrates.', exampleVi: 'Con người và loài chim là động vật có xương sống.' },
      { word: 'invertebrate', phonetic: '/ɪnˈvɜː.tɪ.brət/', wordType: 'noun', meaningEn: 'an animal that does not have a backbone', meaningVi: 'động vật không xương sống', example: 'Insects and jellyfish are invertebrates.', exampleVi: 'Côn trùng và sứa là động vật không xương sống.' },
      { word: 'venomous', phonetic: '/ˈven.ə.məs/', wordType: 'adj', meaningEn: 'producing venom, a toxic substance injected by biting or stinging', meaningVi: 'có độc, tiết chất độc', example: 'Cobras are highly venomous snakes.', exampleVi: 'Rắn hổ mang là loài rắn có độc tính cực cao.' },
      { word: 'plumage', phonetic: '/ˈpluː.mɪdʒ/', wordType: 'noun', meaningEn: 'a bird\'s feathers collectively', meaningVi: 'bộ lông vũ', example: 'The male peacock has magnificent plumage.', exampleVi: 'Công đực sở hữu một bộ lông vũ lộng lẫy.' }
    ]
  },
  {
    id: 'jobs',
  ...
  },
  {
    ...
    advanced: [
      ...
      { word: 'formal', phonetic: '/ˈfɔː.məl/', wordType: 'adj', meaningEn: 'clothes suitable for official or serious occasions', meaningVi: 'trang trọng, lịch sự', example: 'Formal attire is required.', exampleVi: 'Trang phục lịch sự là buộc phải có.' },
  ...
  },
  {
    ...
    advanced: [
      ...
      { word: 'microwave', phonetic: '/ˈmaɪ.krə.weɪv/', wordType: 'noun', meaningEn: 'an oven that uses microwaves to cook or heat food', meaningVi: 'lò vi sóng', example: 'Warm up the pizza in the microwave.', exampleVi: 'Hãy hâm nóng pizza bằng lò vi sóng.' },
  ...
  },
  {
    ...
    beginner: [
      { word: 'house', phonetic: '/haʊs/', wordType: 'noun', meaningEn: 'a building for human habitation', meaningVi: 'ngôi nhà', example: 'They built a big house.', exampleVi: 'Họ đã xây một ngôi nhà lớn.' },
      { word: 'kitchen', phonetic: '/ˈkɪtʃ.ən/', wordType: 'noun', meaningEn: 'a room or area where food is prepared and cooked', meaningVi: 'nhà bếp, phòng bếp', example: 'My mom is cooking in the kitchen.', exampleVi: 'Mẹ tôi đang nấu ăn trong bếp.' },
      { word: 'bedroom', phonetic: '/ˈbed.ruːm/', wordType: 'noun', meaningEn: 'a room for sleeping in', meaningVi: 'phòng ngủ', example: 'My bedroom is clean and quiet.', exampleVi: 'Phòng ngủ của tôi sạch sẽ và yên tĩnh.' },
      { word: 'bathroom', phonetic: '/ˈbɑːθ.ruːm/', wordType: 'noun', meaningEn: 'a room containing a bath or shower and usually a toilet', meaningVi: 'phòng tắm, nhà vệ sinh', example: 'Wash your hands in the bathroom.', exampleVi: 'Hãy rửa tay của bạn trong phòng tắm.' },
      { word: 'living room', phonetic: '/ˈlɪv.ɪŋ ˌruːm/', wordType: 'noun', meaningEn: 'the room in a house that is used for relaxing and entertaining guests', meaningVi: 'phòng khách', example: 'We watch TV in the living room.', exampleVi: 'Chúng tôi xem TV ở phòng khách.' },
      { word: 'wall', phonetic: '/wɔːl/', wordType: 'noun', meaningEn: 'a continuous vertical brick or stone structure that encloses an area', meaningVi: 'bức tường', example: 'The wall is painted light blue.', exampleVi: 'Bức tường được sơn màu xanh dương nhạt.' },
      { word: 'floor', phonetic: '/flɔːr/', wordType: 'noun', meaningEn: 'the lower surface of a room, on which one stands', meaningVi: 'sàn nhà, tầng nhà', example: 'Clean the kitchen floor.', exampleVi: 'Hãy lau sạch sàn nhà bếp.' },
      { word: 'roof', phonetic: '/ruːf/', wordType: 'noun', meaningEn: 'the structure forming the upper covering of a building', meaningVi: 'mái nhà', example: 'Rain is dripping from the roof.', exampleVi: 'Nước mưa đang nhỏ giọt từ mái nhà xuống.' },
      { word: 'garden', phonetic: '/ˈɡɑː.dən/', wordType: 'noun', meaningEn: 'a piece of ground next to a house, used for growing flowers or vegetables', meaningVi: 'khu vườn', example: 'She grows roses in the garden.', exampleVi: 'Cô ấy trồng hoa hồng trong vườn.' },
      { word: 'garage', phonetic: '/ˈɡær.ɑːʒ/', wordType: 'noun', meaningEn: 'a building for housing a motor vehicle or vehicles', meaningVi: 'nhà để xe, ga-ra', example: 'Park the car in the garage.', exampleVi: 'Đỗ xe trong nhà để xe.' },
      { word: 'doorbell', phonetic: '/ˈdɔː.bel/', wordType: 'noun', meaningEn: 'a bell operated by a button beside an outer door', meaningVi: 'chuông cửa', example: 'I heard the doorbell ring.', exampleVi: 'Tôi nghe tiếng chuông cửa reo.' },
      { word: 'gate', phonetic: '/ɡeɪt/', wordType: 'noun', meaningEn: 'a hinged barrier used to close an opening in a wall or fence', meaningVi: 'cái cổng', example: 'Close the iron gate, please.', exampleVi: 'Làm ơn hãy đóng cổng sắt lại.' },
      { word: 'ceiling', phonetic: '/ˈsiː.lɪŋ/', wordType: 'noun', meaningEn: 'the upper interior surface of a room', meaningVi: 'trần nhà', example: 'A lamp hangs from the ceiling.', exampleVi: 'Một chiếc đèn treo trên trần nhà.' },
      { word: 'yard', phonetic: '/jɑːd/', wordType: 'noun', meaningEn: 'an area of land next to a building, usually covered with grass', meaningVi: 'cái sân', example: 'Children are playing in the yard.', exampleVi: 'Trẻ con đang chơi ngoài sân.' },
      { word: 'stairs', phonetic: '/steəz/', wordType: 'noun pl', meaningEn: 'a set of steps leading from one floor of a building to another', meaningVi: 'cầu thang', example: 'He walked up the stairs.', exampleVi: 'Anh ấy đã bước lên cầu thang.' }
    ],
    advanced: [
      { word: 'apartment', phonetic: '/əˈpɑːt.mənt/', wordType: 'noun', meaningEn: 'a suite of rooms forming one residence, typically in a building', meaningVi: 'căn hộ chung cư', example: 'She rented a two-bedroom apartment.', exampleVi: 'Cô ấy đã thuê một căn hộ hai phòng ngủ.' },
      { word: 'basement', phonetic: '/ˈbeɪs.mənt/', wordType: 'noun', meaningEn: 'the floor of a building which is partly or entirely below ground level', meaningVi: 'tầng hầm', example: 'We store old furniture in the basement.', exampleVi: 'Chúng tôi cất giữ đồ đạc cũ dưới tầng hầm.' },
      { word: 'attic', phonetic: '/ˈæt.ɪk/', wordType: 'noun', meaningEn: 'a space or room inside or partly in the roof of a building', meaningVi: 'gác mái, phòng áp mái', example: 'She found old letters in the attic.', exampleVi: 'Cô ấy tìm thấy những bức thư cũ trên gác mái.' },
      { word: 'balcony', phonetic: '/ˈbæl.kə.ni/', wordType: 'noun', meaningEn: 'a platform projecting from the wall of a building', meaningVi: 'ban công', example: 'He was standing on the balcony.', exampleVi: 'Anh ấy đã đứng ngoài ban công.' },
      { word: 'corridor', phonetic: '/ˈkɒr.ɪ.dɔːr/', wordType: 'noun', meaningEn: 'a long passage in a building from which doors lead into rooms', meaningVi: 'hành lang', example: 'His office is down the corridor.', exampleVi: 'Văn phòng của anh ấy nằm ở cuối hành lang.' },
      { word: 'fireplace', phonetic: '/ˈfaɪə.pleɪs/', wordType: 'noun', meaningEn: 'a place for a domestic fire, especially a grate at base of chimney', meaningVi: 'lò sưởi', example: 'We sat close to the fireplace.', exampleVi: 'Chúng tôi đã ngồi gần lò sưởi.' },
      { word: 'insulation', phonetic: '/ˌɪn.sjəˈleɪ.ʃən/', wordType: 'noun', meaningEn: 'material used to insulate something, especially a building', meaningVi: 'vật liệu cách nhiệt/cách âm', example: 'Good insulation saves energy.', exampleVi: 'Cách nhiệt tốt giúp tiết kiệm năng lượng.' },
      { word: 'mortgage', phonetic: '/ˈmɔː.ɡɪdʒ/', wordType: 'noun', meaningEn: 'a legal agreement by which a bank lends money for buying property', meaningVi: 'khoản vay thế chấp mua nhà', example: 'They took out a mortgage to buy the house.', exampleVi: 'Họ đã vay thế chấp ngân hàng để mua ngôi nhà đó.' },
      { word: 'tenant', phonetic: '/ˈten.ənt/', wordType: 'noun', meaningEn: 'a person who occupies land or property rented from a landlord', meaningVi: 'người thuê nhà', example: 'The tenant paid the rent on time.', exampleVi: 'Người thuê nhà đã trả tiền nhà đúng hạn.' },
      { word: 'landlord', phonetic: '/ˈlænd.lɔːd/', wordType: 'noun', meaningEn: 'a person who rents land, a building, or an apartment to a tenant', meaningVi: 'chủ nhà, chủ đất', example: 'The landlord agreed to repair the door.', exampleVi: 'Chủ nhà đã đồng ý sửa chữa cánh cửa.' },
      { word: 'renovation', phonetic: '/ˌren.əˈveɪ.ʃən/', wordType: 'noun', meaningEn: 'the action of renovating a building or room', meaningVi: 'sự đổi mới, cải tạo sửa sang nhà', example: 'The house is undergoing renovation.', exampleVi: 'Ngôi nhà đang được cải tạo sửa chữa.' },
      { word: 'dwelling', phonetic: '/ˈdwel.ɪŋ/', wordType: 'noun', meaningEn: 'a house, flat, or other place of residence', meaningVi: 'nơi ở, trú ngụ', example: 'A cottage was their only dwelling.', exampleVi: 'Một túp lều tranh là nơi ở duy nhất của họ.' },
      { word: 'suburb', phonetic: '/ˈsʌb.ɜːb/', wordType: 'noun', meaningEn: 'an outlying district of a city, especially a residential one', meaningVi: 'vùng ngoại ô', example: 'They live in a quiet suburb.', exampleVi: 'Họ sống ở một vùng ngoại ô yên tĩnh.' },
      { word: 'ventilation', phonetic: '/ˌven.tɪˈleɪ.ʃən/', wordType: 'noun', meaningEn: 'the provision of fresh air to a room or building', meaningVi: 'sự thông gió, hệ thống thông gió', example: 'The bathroom needs better ventilation.', exampleVi: 'Phòng tắm cần hệ thống thông gió tốt hơn.' },
      { word: 'chimney', phonetic: '/ˈtʃɪm.ni/', wordType: 'noun', meaningEn: 'a vertical pipe which conducts smoke and gases up from a fire', meaningVi: 'ống khói', example: 'Smoke poured out of the chimney.', exampleVi: 'Khói cuộn bay ra từ ống khói.' }
    ]
  },
  {
    id: 'vehicles',
    ...
    beginner: [
      { word: 'car', phonetic: '/kɑːr/', wordType: 'noun', meaningEn: 'a road vehicle, typically with four wheels, powered by an engine', meaningVi: 'xe hơi, ô tô', example: 'He drives a blue car.', exampleVi: 'Anh ấy lái một chiếc xe hơi màu xanh.' },
      { word: 'bus', phonetic: '/bʌs/', wordType: 'noun', meaningEn: 'a large motor vehicle carrying passengers by road', meaningVi: 'xe buýt', example: 'I go to school by bus.', exampleVi: 'Tôi đi học bằng xe buýt.' },
      { word: 'bicycle', phonetic: '/ˈbaɪ.sɪ.kəl/', wordType: 'noun', meaningEn: 'a vehicle consisting of two wheels held in a frame one behind the other', meaningVi: 'xe đạp', example: 'She rides her bicycle to the park.', exampleVi: 'Cô ấy đi xe đạp đến công viên.' },
      { word: 'train', phonetic: '/treɪn/', wordType: 'noun', meaningEn: 'a series of connected railway carriages or wagons', meaningVi: 'tàu hỏa, xe lửa', example: 'The train leaves at ten.', exampleVi: 'Tàu hỏa khởi hành lúc 10 giờ.' },
      { word: 'plane', phonetic: '/pleɪn/', wordType: 'noun', meaningEn: 'an airplane', meaningVi: 'máy bay', example: 'The plane is flying above the clouds.', exampleVi: 'Máy bay đang bay trên những tầng mây.' },
      { word: 'boat', phonetic: '/bəʊt/', wordType: 'noun', meaningEn: 'a small vessel for travelling on water', meaningVi: 'thuyền, con đò', example: 'We rented a row boat.', exampleVi: 'Chúng tôi đã thuê một chiếc thuyền mái chèo.' },
      { word: 'ship', phonetic: '/ʃɪp/', wordType: 'noun', meaningEn: 'a large boat for transporting people or goods by sea', meaningVi: 'tàu thủy, tàu lớn', example: 'A cargo ship crossed the ocean.', exampleVi: 'Một chiếc tàu chở hàng đã vượt đại dương.' },
      { word: 'motorcycle', phonetic: '/ˈməʊ.tə.saɪ.kəl/', wordType: 'noun', meaningEn: 'a two-wheeled vehicle that is powered by an engine', meaningVi: 'xe máy, xe mô tô', example: 'He bought a new motorcycle.', exampleVi: 'Anh ấy đã mua một chiếc xe máy mới.' },
      { word: 'truck', phonetic: '/trʌk/', wordType: 'noun', meaningEn: 'a large, heavy road vehicle used for carrying goods', meaningVi: 'xe tải', example: 'The delivery truck arrived.', exampleVi: 'Chiếc xe tải giao hàng đã đến.' },
      { word: 'helicopter', phonetic: '/ˈhel.ɪ.kɒp.tər/', wordType: 'noun', meaningEn: 'a type of aircraft with large blades on top that spin round', meaningVi: 'máy bay trực thăng', example: 'A rescue helicopter arrived.', exampleVi: 'Trực thăng cứu hộ đã có mặt.' },
      { word: 'taxi', phonetic: '/ˈtæk.si/', wordType: 'noun', meaningEn: 'a motor car licensed to transport passengers for a fare', meaningVi: 'xe taxi', example: 'Call a taxi for me, please.', exampleVi: 'Làm ơn hãy gọi cho tôi một chiếc taxi.' },
      { word: 'airport', phonetic: '/ˈeə.pɔːt/', wordType: 'noun', meaningEn: 'a complex of runways and buildings for the take-off and landing of planes', meaningVi: 'sân bay, phi trường', example: 'We arrived at the airport early.', exampleVi: 'Chúng tôi đã đến sân bay từ sớm.' },
      { word: 'ticket', phonetic: '/ˈtɪk.ɪt/', wordType: 'noun', meaningEn: 'a piece of paper showing that you have paid for a journey', meaningVi: 'vé xe, vé tàu, vé máy bay', example: 'Show your train ticket.', exampleVi: 'Hãy xuất trình vé tàu của bạn.' },
      { word: 'subway', phonetic: '/ˈsʌb.weɪ/', wordType: 'noun', meaningEn: 'an underground railway system', meaningVi: 'tàu điện ngầm', example: 'New York is famous for its subway.', exampleVi: 'New York nổi tiếng với hệ thống tàu điện ngầm.' },
      { word: 'traffic light', phonetic: '/ˈtræf.ɪk laɪt/', wordType: 'noun', meaningEn: 'a set of automatically operated colored lights for controlling traffic', meaningVi: 'đèn giao thông', example: 'Stop at the red traffic light.', exampleVi: 'Hãy dừng lại trước đèn giao thông đỏ.' }
    ],
    advanced: [
      { word: 'transportation', phonetic: '/ˌtræn.spɔːˈteɪ.ʃən/', wordType: 'noun', meaningEn: 'the action of transporting someone or something, or a system for doing this', meaningVi: 'hệ thống giao thông, sự vận tải', example: 'Public transportation is efficient here.', exampleVi: 'Giao thông công cộng ở đây rất hiệu quả.' },
      { word: 'commuter', phonetic: '/kəˈmjuː.tər/', wordType: 'noun', meaningEn: 'a person who travels some distance to work on a regular basis', meaningVi: 'người đi làm xa bằng phương tiện công cộng', example: 'The train was packed with commuters.', exampleVi: 'Tàu hỏa chật kín người đi làm.' },
      { word: 'pedestrian', phonetic: '/pəˈdes.tri.ən/', wordType: 'noun', meaningEn: 'a person walking rather than travelling in a vehicle', meaningVi: 'người đi bộ', example: 'Drivers must yield to pedestrians.', exampleVi: 'Tài xế phải nhường đường cho người đi bộ.' },
      { word: 'congestion', phonetic: '/kənˈdʒes.tʃən/', wordType: 'noun', meaningEn: 'the state of being overcrowded, especially with traffic', meaningVi: 'sự tắc nghẽn, kẹt xe', example: 'Traffic congestion is a major issue.', exampleVi: 'Tắc nghẽn giao thông là một vấn đề lớn.' },
      { word: 'navigation', phonetic: '/ˌnæv.ɪˈɡeɪ.ʃən/', wordType: 'noun', meaningEn: 'the process of monitoring and controlling the movement of a craft', meaningVi: 'sự định hướng, điều hướng', example: 'The ship has satellite navigation.', exampleVi: 'Con tàu được trang bị hệ thống định vị vệ tinh.' },
      { word: 'transmission', phonetic: '/trænzˈmɪʃ.ən/', wordType: 'noun', meaningEn: 'the mechanism by which power is transmitted from an engine to the wheels', meaningVi: 'hộp số, hệ thống truyền động', example: 'An automatic transmission car.', exampleVi: 'Một chiếc ô tô hộp số tự động.' },
      { word: 'autonomous', phonetic: '/ɔːˈtɒn.ə.məs/', wordType: 'adj', meaningEn: 'operating without direct human control; self-driving', meaningVi: 'tự lái, tự trị', example: 'Autonomous vehicles are the future.', exampleVi: 'Xe tự lái là xu hướng của tương lai.' },
      { word: 'expressway', phonetic: '/ɪkˈspres.weɪ/', wordType: 'noun', meaningEn: 'a highway designed for fast traffic', meaningVi: 'đường cao tốc', example: 'We drove along the expressway.', exampleVi: 'Chúng tôi đã lái xe dọc theo đường cao tốc.' },
      { word: 'velocity', phonetic: '/vəˈlɒs.ə.ti/', wordType: 'noun', meaningEn: 'the speed of something in a given direction', meaningVi: 'vận tốc', example: 'Calculate the velocity of the vehicle.', exampleVi: 'Hãy tính vận tốc của phương tiện.' },
      { word: 'infraction', phonetic: '/ɪnˈfræk.ʃən/', wordType: 'noun', meaningEn: 'a violation of a law, agreement, or set of rules', meaningVi: 'sự vi phạm (giao thông/luật)', example: 'Speeding is a serious traffic infraction.', exampleVi: 'Vượt quá tốc độ là vi phạm giao thông nghiêm trọng.' },
      { word: 'locomotive', phonetic: '/ˌləʊ.kəˈməʊ.tɪv/', wordType: 'noun', meaningEn: 'a powered railway vehicle used for pulling trains', meaningVi: 'đầu máy xe lửa', example: 'The steam locomotive is in the museum.', exampleVi: 'Đầu máy xe lửa hơi nước đang được trưng bày ở bảo tàng.' },
      { word: 'commute', phonetic: '/kəˈmjuːt/', wordType: 'verb/noun', meaningEn: 'to travel regularly between work and home', meaningVi: 'hành trình đi lại làm việc', example: 'My daily commute takes one hour.', exampleVi: 'Hành trình đi làm hàng ngày của tôi mất 1 tiếng.' },
      { word: 'detour', phonetic: '/ˈdiː.tʊər/', wordType: 'noun', meaningEn: 'a long or roundabout route taken to avoid something', meaningVi: 'đường vòng', example: 'Roadworks forced us to take a detour.', exampleVi: 'Công trình làm đường buộc chúng tôi phải đi đường vòng.' },
      { word: 'gridlock', phonetic: '/ˈɡrɪd.lɒk/', wordType: 'noun', meaningEn: 'a traffic jam affecting a whole network of intersecting streets', meaningVi: 'sự tê liệt giao thông, tắc nghẽn toàn bộ', example: 'The storm caused total gridlock.', exampleVi: 'Cơn bão đã gây ra sự tê liệt giao thông hoàn toàn.' },
      { word: 'tollbooth', phonetic: '/ˈtəʊl.buːð/', wordType: 'noun', meaningEn: 'a kiosk where a driver pays a toll for using a highway or bridge', meaningVi: 'trạm thu phí', example: 'Have cash ready for the tollbooth.', exampleVi: 'Hãy chuẩn bị sẵn tiền mặt cho trạm thu phí.' }
    ]
  },
  {
    id: 'company',
    ...
    beginner: [
      { word: 'company', phonetic: '/ˈkʌm.pə.ni/', wordType: 'noun', meaningEn: 'a commercial business', meaningVi: 'công ty', example: 'He works for an IT company.', exampleVi: 'Anh ấy làm việc cho một công ty công nghệ thông tin.' },
      { word: 'office', phonetic: '/ˈɒf.ɪs/', wordType: 'noun', meaningEn: 'a room or building where people work at desks', meaningVi: 'văn phòng', example: 'Our office is on the fifth floor.', exampleVi: 'Văn phòng của chúng tôi ở tầng năm.' },
      { word: 'boss', phonetic: '/bɒs/', wordType: 'noun', meaningEn: 'a person who is in charge of other employees', meaningVi: 'sếp, người chủ', example: 'My boss is demanding but fair.', exampleVi: 'Sếp của tôi khó tính nhưng công bằng.' },
      { word: 'employee', phonetic: '/ɪmˈplɔɪ.iː/', wordType: 'noun', meaningEn: 'a person employed for wages or salary', meaningVi: 'nhân viên, người làm thuê', example: 'The company has fifty employees.', exampleVi: 'Công ty có 50 nhân viên.' },
      { word: 'meeting', phonetic: '/ˈmiː.tɪŋ/', wordType: 'noun', meaningEn: 'an assembly of people for discussion', meaningVi: 'cuộc họp', example: 'We have a staff meeting at ten.', exampleVi: 'Chúng tôi có cuộc họp nhân viên vào lúc 10 giờ.' },
      { word: 'business', phonetic: '/ˈbɪz.nɪs/', wordType: 'noun', meaningEn: 'the activity of making, buying, and selling goods or services for money', meaningVi: 'doanh nghiệp, kinh doanh', example: 'They run a family business.', exampleVi: 'Họ điều hành một doanh nghiệp gia đình.' },
      { word: 'salary', phonetic: '/ˈsæl.ər.i/', wordType: 'noun', meaningEn: 'a fixed regular payment made by an employer to an employee', meaningVi: 'tiền lương', example: 'She receives a high monthly salary.', exampleVi: 'Cô ấy nhận lương tháng cao.' },
      { word: 'customer', phonetic: '/ˈkʌs.tə.mər/', wordType: 'noun', meaningEn: 'a person who buys goods or services from a shop or business', meaningVi: 'khách hàng', example: 'The customer is always right.', exampleVi: 'Khách hàng luôn luôn đúng.' },
      { word: 'project', phonetic: '/ˈprɒdʒ.ekt/', wordType: 'noun', meaningEn: 'an individual or collaborative enterprise that is carefully planned', meaningVi: 'dự án', example: 'We are working on a new project.', exampleVi: 'Chúng tôi đang thực hiện một dự án mới.' },
      { word: 'partner', phonetic: '/ˈpɑːt.nər/', wordType: 'noun', meaningEn: 'a person who takes part in an undertaking with another', meaningVi: 'đối tác, cộng sự', example: 'He is a business partner.', exampleVi: 'Anh ấy là một đối tác kinh doanh.' },
      { word: 'product', phonetic: '/ˈprɒd.ʌkt/', wordType: 'noun', meaningEn: 'an article or substance that is manufactured or refined for sale', meaningVi: 'sản phẩm', example: 'Our products are sold worldwide.', exampleVi: 'Sản phẩm của chúng tôi được bán trên toàn thế giới.' },
      { word: 'team', phonetic: '/tiːm/', wordType: 'noun', meaningEn: 'a group of players or workers forming one side in a competitive activity', meaningVi: 'đội nhóm', example: 'Our marketing team is talented.', exampleVi: 'Đội marketing của chúng tôi rất tài năng.' },
      { word: 'department', phonetic: '/dɪˈpɑːt.mənt/', wordType: 'noun', meaningEn: 'a division of a large organization or shop', meaningVi: 'phòng ban', example: 'Contact the sales department.', exampleVi: 'Hãy liên hệ với phòng bán hàng.' },
      { word: 'client', phonetic: '/ˈklaɪ.ənt/', wordType: 'noun', meaningEn: 'a person or organization using the services of a professional person', meaningVi: 'khách hàng đối tác', example: 'We must keep our clients happy.', exampleVi: 'Chúng ta phải làm hài lòng các khách hàng của mình.' },
      { word: 'contract', phonetic: '/ˈkɒn.trækt/', wordType: 'noun', meaningEn: 'a written or spoken agreement, especially one concerning employment or sales', meaningVi: 'hợp đồng', example: 'Sign the employment contract.', exampleVi: 'Hãy ký hợp đồng lao động.' }
    ],
    advanced: [
      { word: 'corporation', phonetic: '/ˌkɔː.pərˈeɪ.ʃən/', wordType: 'noun', meaningEn: 'a large company or group of companies authorized to act as a single entity', meaningVi: 'tập đoàn lớn', example: 'She works for a multinational corporation.', exampleVi: 'Cô ấy làm việc cho một tập đoàn đa quốc gia.' },
      { word: 'headquarters', phonetic: '/ˌhedˈkwɔː.təz/', wordType: 'noun pl', meaningEn: 'the premises serving as the administrative center of an enterprise', meaningVi: 'trụ sở chính', example: 'The company\'s headquarters are in London.', exampleVi: 'Trụ sở chính của công ty nằm ở Luân Đôn.' },
      { word: 'boardroom', phonetic: '/ˈbɔːd.ruːm/', wordType: 'noun', meaningEn: 'a room where the board of directors of a company meets', meaningVi: 'phòng họp ban quản trị', example: 'The board met in the main boardroom.', exampleVi: 'Ban giám đốc đã họp tại phòng họp ban quản trị chính.' },
      { word: 'acquisition', phonetic: '/ˌæk.wɪˈzɪʃ.ən/', wordType: 'noun', meaningEn: 'an asset or object bought or obtained, typically by a library or museum', meaningVi: 'sự mua lại, thâu tóm doanh nghiệp', example: 'The acquisition of the rival firm.', exampleVi: 'Sự mua lại thâu tóm công ty đối thủ.' },
      { word: 'strategy', phonetic: '/ˈstræt.ə.dʒi/', wordType: 'noun', meaningEn: 'a plan of action designed to achieve a long-term or overall aim', meaningVi: 'chiến lược', example: 'We need a clear business strategy.', exampleVi: 'Chúng ta cần một chiến lược kinh doanh rõ ràng.' },
      { word: 'deficit', phonetic: '/ˈdef.ɪ.sɪt/', wordType: 'noun', meaningEn: 'the amount by which something, especially a sum of money, is too small', meaningVi: 'sự thâm hụt tài chính', example: 'The trade deficit has widened.', exampleVi: 'Thâm hụt thương mại đã nới rộng hơn.' },
      { word: 'shareholder', phonetic: '/ˈʃeəˌhəʊl.dər/', wordType: 'noun', meaningEn: 'an owner of shares in a company', meaningVi: 'cổ đông', example: 'The shareholders voted for the merger.', exampleVi: 'Các cổ đông đã bỏ phiếu thông qua việc sáp nhập.' },
      { word: 'infrastructure', phonetic: '/ˈɪn.frəˌstrʌk.tʃər/', wordType: 'noun', meaningEn: 'the basic physical structures needed for the operation of a society or enterprise', meaningVi: 'cơ sở hạ tầng', example: 'The firm invested in IT infrastructure.', exampleVi: 'Công ty đã đầu tư vào cơ sở hạ tầng CNTT.' },
      { word: 'subsidiary', phonetic: '/səbˈsɪd.i.ə.ri/', wordType: 'noun', meaningEn: 'a company controlled by a holding company', meaningVi: 'công ty con', example: 'Our firm is a subsidiary of a French giant.', exampleVi: 'Công ty chúng tôi là công ty con của một gã khổng lồ Pháp.' },
      { word: 'conglomerate', phonetic: '/kənˈɡlɒm.ər.ət/', wordType: 'noun', meaningEn: 'a multi-industry company that combination of multiple business entities', meaningVi: 'tập đoàn đa ngành khổng lồ', example: 'A media conglomerate owns the TV station.', exampleVi: 'Một tập đoàn truyền thông đa ngành sở hữu đài truyền hình.' },
      { word: 'bankruptcy', phonetic: '/ˈbæŋ.krəpt.si/', wordType: 'noun', meaningEn: 'the state of being completely lacking in money and unable to pay debts', meaningVi: 'sự phá sản', example: 'The firm declared bankruptcy last month.', exampleVi: 'Công ty đã tuyên bố phá sản vào tháng trước.' },
      { word: 'superintendent', phonetic: '/ˌsuː.pər.ɪnˈten.dənt/', wordType: 'noun', meaningEn: 'a person who directs and manages an organization', meaningVi: 'người giám sát, người quản lý cấp cao', example: 'The superintendent inspected the site.', exampleVi: 'Người giám sát cấp cao đã thanh tra địa điểm này.' },
      { word: 'entrepreneurship', phonetic: '/ˌɒn.trə.prəˈnɜː.ʃɪp/', wordType: 'noun', meaningEn: 'the activity of setting up a business, taking on financial risks', meaningVi: 'tinh thần khởi nghiệp', example: 'The college fosters entrepreneurship.', exampleVi: 'Trường đại học bồi dưỡng tinh thần khởi nghiệp.' },
      { word: 'remuneration', phonetic: '/rɪˌmjuː.nərˈeɪ.ʃən/', wordType: 'noun', meaningEn: 'money paid for work or a service', meaningVi: 'thù lao, tiền công trả thưởng', example: 'They demanded fair remuneration.', exampleVi: 'Họ yêu cầu một mức thù lao công bằng.' },
      { word: 'bureaucracy', phonetic: '/bjʊəˈrɒk.rə.si/', wordType: 'noun', meaningEn: 'a system of government in which decisions are made by state officials', meaningVi: 'thói quan liêu, bộ máy hành chính cồng kềnh', example: 'Small businesses struggle with bureaucracy.', exampleVi: 'Các doanh nghiệp nhỏ gặp khó khăn với bộ máy hành chính cồng kềnh.' }
    ]
  },
  {
    id: 'it',
    ...
    beginner: [
      { word: 'computer', phonetic: '/kəmˈpjuː.tər/', wordType: 'noun', meaningEn: 'an electronic device for storing and processing data', meaningVi: 'máy tính', example: 'I bought a new computer.', exampleVi: 'Tôi đã mua một chiếc máy tính mới.' },
      { word: 'internet', phonetic: '/ˈɪn.tə.net/', wordType: 'noun', meaningEn: 'a global computer network providing a variety of information', meaningVi: 'mạng internet', example: 'Search for it on the internet.', exampleVi: 'Hãy tìm kiếm nó trên mạng internet.' },
      { word: 'website', phonetic: '/ˈweb.saɪt/', wordType: 'noun', meaningEn: 'a set of related web pages located under a single domain name', meaningVi: 'trang web', example: 'Visit our official website.', exampleVi: 'Hãy ghé thăm trang web chính thức của chúng tôi.' },
      { word: 'software', phonetic: '/ˈsɒft.weər/', wordType: 'noun', meaningEn: 'the programs and other operating information used by a computer', meaningVi: 'phần mềm', example: 'Install the anti-virus software.', exampleVi: 'Hãy cài đặt phần mềm diệt vi-rút.' },
      { word: 'keyboard', phonetic: '/ˈkiː.bɔːd/', wordType: 'noun', meaningEn: 'a panel of keys that operates a computer or typewriter', meaningVi: 'bàn phím', example: 'Clean the dust off the keyboard.', exampleVi: 'Lau sạch bụi khỏi bàn phím.' },
      { word: 'screen', phonetic: '/skriːn/', wordType: 'noun', meaningEn: 'a flat surface in a cinema or on a television or computer on which pictures are shown', meaningVi: 'màn hình', example: 'Look at the computer screen.', exampleVi: 'Nhìn vào màn hình máy tính kìa.' },
      { word: 'network', phonetic: '/ˈnet.wɜːk/', wordType: 'noun', meaningEn: 'a group of two or more computer systems linked together', meaningVi: 'mạng lưới, hệ mạng', example: 'The network is slow today.', exampleVi: 'Hệ thống mạng hôm nay bị chậm.' },
      { word: 'folder', phonetic: '/ˈfəʊl.dər/', wordType: 'noun', meaningEn: 'an icon on a computer screen that can be used to group documents together', meaningVi: 'thư mục', example: 'Create a new folder for photos.', exampleVi: 'Hãy tạo một thư mục mới cho ảnh.' },
      { word: 'file', phonetic: '/faɪl/', wordType: 'noun', meaningEn: 'a resource for storing information, which is available to a computer program', meaningVi: 'tập tin, tệp tin', example: 'Save the file before closing.', exampleVi: 'Hãy lưu tập tin trước khi đóng.' },
      { word: 'password', phonetic: '/ˈpɑːs.wɜːd/', wordType: 'noun', meaningEn: 'a secret word or phrase that must be used to gain admission to something', meaningVi: 'mật khẩu', example: 'Never share your password.', exampleVi: 'Đừng bao giờ chia sẻ mật khẩu của bạn.' },
      { word: 'online', phonetic: '/ˌɒnˈlaɪn/', wordType: 'adj/adv', meaningEn: 'connected to the internet', meaningVi: 'trực tuyến, kết nối mạng', example: 'The system is online now.', exampleVi: 'Hệ thống hiện đang trực tuyến.' },
      { word: 'mouse', phonetic: '/maʊs/', wordType: 'noun', meaningEn: 'a small handheld device which is moved across a flat surface to move screen cursor', meaningVi: 'chuột máy tính', example: 'This wireless mouse is smooth.', exampleVi: 'Chú chuột không dây này dùng rất mượt.' },
      { word: 'data', phonetic: '/ˈdeɪ.tə/', wordType: 'noun', meaningEn: 'facts and statistics collected together for reference or analysis', meaningVi: 'dữ liệu', example: 'Backup your data regularly.', exampleVi: 'Sao lưu dữ liệu của bạn thường xuyên.' },
      { word: 'email', phonetic: '/ˈiː.meɪl/', wordType: 'noun/verb', meaningEn: 'messages distributed by electronic means from one computer user to one or more recipients', meaningVi: 'thư điện tử, gửi email', example: 'I sent you an email yesterday.', exampleVi: 'Tôi đã gửi email cho bạn vào hôm qua.' },
      { word: 'hardware', phonetic: '/ˈhɑːd.weər/', wordType: 'noun', meaningEn: 'tools, machinery, and other durable equipment, or physical parts of computer', meaningVi: 'phần cứng máy tính', example: 'Upgrading the hardware makes PC faster.', exampleVi: 'Nâng cấp phần cứng giúp máy tính chạy nhanh hơn.' }
    ],
    advanced: [
      { word: 'algorithm', phonetic: '/ˈæl.ɡə.rɪ.ðəm/', wordType: 'noun', meaningEn: 'a process or set of rules to be followed in calculations or problem-solving', meaningVi: 'thuật toán', example: 'This algorithm optimizes the search.', exampleVi: 'Thuật toán này giúp tối ưu hóa tìm kiếm.' },
      { word: 'database', phonetic: '/ˈdeɪ.tə.beɪs/', wordType: 'noun', meaningEn: 'a structured set of data held in a computer, especially one that is accessible in various ways', meaningVi: 'cơ sở dữ liệu', example: 'We store user logs in the database.', exampleVi: 'Chúng tôi lưu nhật ký người dùng trong cơ sở dữ liệu.' },
      { word: 'encryption', phonetic: '/ɪnˈkrɪp.ʃən/', wordType: 'noun', meaningEn: 'the process of converting information or data into a code, especially to prevent unauthorized access', meaningVi: 'sự mã hóa, bảo mật dữ liệu', example: 'Strong encryption secures communications.', exampleVi: 'Mã hóa mạnh mẽ giúp bảo mật các cuộc hội thoại.' },
      { word: 'cybersecurity', phonetic: '/ˌsaɪ.bə.sɪˈkjʊə.rə.ti/', wordType: 'noun', meaningEn: 'the state of being protected against the criminal use of electronic data', meaningVi: 'an ninh mạng', example: 'Cybersecurity is a top priority for banks.', exampleVi: 'An ninh mạng là ưu tiên hàng đầu của các ngân hàng.' },
      { word: 'repository', phonetic: '/rɪˈpɒz.ɪ.tər.i/', wordType: 'noun', meaningEn: 'a place where things are stored, or a central location in Git', meaningVi: 'kho lưu trữ mã nguồn (Git)', example: 'Push the new changes to the repository.', exampleVi: 'Đẩy các thay đổi mới lên kho lưu trữ.' },
      { word: 'artificial intelligence', phonetic: '/ˌɑː.tɪ.fɪʃ.əl ɪnˈtel.ɪ.dʒəns/', wordType: 'noun', meaningEn: 'computer systems able to perform tasks that normally require human intelligence', meaningVi: 'trí tuệ nhân tạo (AI)', example: 'Artificial intelligence is changing the world.', exampleVi: 'Trí tuệ nhân tạo đang thay đổi thế giới.' },
      { word: 'cloud computing', phonetic: '/klaʊd kəmˈpjuː.tɪŋ/', wordType: 'noun', meaningEn: 'the practice of using a network of remote servers hosted on the internet to store data', meaningVi: 'điện toán đám mây', example: 'We host our web app on cloud computing.', exampleVi: 'Chúng tôi vận hành ứng dụng web trên điện toán đám mây.' },
      { word: 'debugging', phonetic: '/ˌdiːˈbʌɡ.ɪŋ/', wordType: 'noun', meaningEn: 'the process of identifying and removing errors from computer hardware or software', meaningVi: 'quá trình gỡ lỗi, fix bug', example: 'I spent all night debugging the code.', exampleVi: 'Tôi dành cả đêm để gỡ lỗi code.' },
      { word: 'framework', phonetic: '/ˈfreɪm.wɜːk/', wordType: 'noun', meaningEn: 'a basic structure underlying a system, concept, or text, or software platform', meaningVi: 'khung phần mềm, thư viện nền tảng', example: 'React is a popular frontend framework.', exampleVi: 'React là một framework frontend rất phổ biến.' },
      { word: 'protocol', phonetic: '/ˈprəʊ.tə.kɒl/', wordType: 'noun', meaningEn: 'a set of rules governing the exchange or transmission of data between devices', meaningVi: 'giao thức truyền thông', example: 'HTTPS is a secure web protocol.', exampleVi: 'HTTPS là một giao thức web an toàn.' },
      { word: 'compiler', phonetic: '/kəmˈpaɪ.lər/', wordType: 'noun', meaningEn: 'a program that translates computer code from one language to another', meaningVi: 'trình biên dịch', example: 'The C++ compiler generated an error.', exampleVi: 'Trình biên dịch C++ đã tạo ra lỗi.' },
      { word: 'middleware', phonetic: '/ˈmɪd.əl.weər/', wordType: 'noun', meaningEn: 'software that acts as a bridge between an operating system or database and applications', meaningVi: 'phần mềm trung gian', example: 'The authentication middleware intercepts requests.', exampleVi: 'Middleware xác thực chặn các yêu cầu gửi đến.' },
      { word: 'optimization', phonetic: '/ˌɒp.tɪ.maɪˈzeɪ.ʃən/', wordType: 'noun', meaningEn: 'the action of making the best or most effective use of a resource', meaningVi: 'sự tối ưu hóa', example: 'Code optimization improves page load speed.', exampleVi: 'Tối ưu hóa code cải thiện tốc độ tải trang.' },
      { word: 'bandwidth', phonetic: '/ˈbænd.wɪtθ/', wordType: 'noun', meaningEn: 'the range of frequencies within a given band, in IT: data transfer rate', meaningVi: 'băng thông truyền dữ liệu', example: 'Video streaming requires high bandwidth.', exampleVi: 'Phát video trực tuyến đòi hỏi băng thông lớn.' },
      { word: 'vulnerability', phonetic: '/ˌvʌl.nər.əˈbɪl.ə.ti/', wordType: 'noun', meaningEn: 'a flaw or weakness in system security procedures or design', meaningVi: 'lỗ hổng bảo mật', example: 'Patch the system to fix the vulnerability.', exampleVi: 'Hãy vá hệ thống để khắc phục lỗ hổng bảo mật.' }
    ]
  }
];
